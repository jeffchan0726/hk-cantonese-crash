(function () {
  function extras() {
    ...
    SUCHENG.cantonese = (SUCHENG.cantonese || []).concat(
      ["哋","佢","齩","咇","喎","真","花","專","業","援","報","壓","力","阿","叔","梗","班","膠","散","打","港","喃","嘅","唔"]
    );
  }
  function bootApp() {
    extras();
    var a = document.createElement("script");
    a.src = "js/app.js?v=19";
